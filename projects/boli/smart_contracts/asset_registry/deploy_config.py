# ~/Desktop/boli/projects/boli/smart_contracts/asset_registry/deploy_config.py
...
def deploy() -> None:
    """Deploy the Asset Registry contract."""
    # Import directly from contract.py
    from smart_contracts.asset_registry.contract import asset_registry_app
    ...
    try:
        ...
        logger.info(f"Deployed Asset Registry app with ID: {app_id} and address: {app_addr}")
