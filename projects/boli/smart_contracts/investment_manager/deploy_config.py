# ~/Desktop/boli/projects/boli/smart_contracts/investment_manager/deploy_config.py
...
def deploy() -> None:
    """Deploy the Investment Manager contract."""
    # Import directly from contract.py
    from smart_contracts.investment_manager.contract import investment_manager_app
    ...
    try:
        ...
        logger.info(f"Deployed Investment Manager app with ID: {app_id} and address: {app_addr}")
