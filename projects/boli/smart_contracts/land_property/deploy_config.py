# ~/Desktop/boli/projects/boli/smart_contracts/land_property/deploy_config.py
...
def deploy() -> None:
    """Deploy the land property contract."""
    # Import directly from contract.py
    from smart_contracts.land_property.contract import land_property_app
