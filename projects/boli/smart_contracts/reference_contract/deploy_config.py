# ~/Desktop/boli/projects/boli/smart_contracts/reference_contract/deploy_config.py
...
def deploy() -> None:
    ...
    from smart_contracts.reference_contract.contract import reference_app
    ...
    try:
        ...
        logger.info(
            f"Called hello on BoliPlatform ({app_id}) "
