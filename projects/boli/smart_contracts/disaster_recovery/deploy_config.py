# ~/Desktop/boli/projects/boli/smart_contracts/disaster_recovery/deploy_config.py
...
def deploy() -> None:
    """Deploy the disaster recovery contract."""
    # Import directly from contract.py
    from smart_contracts.disaster_recovery.contract import disaster_recovery_app
