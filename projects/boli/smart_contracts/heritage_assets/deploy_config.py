# ~/Desktop/boli/projects/boli/smart_contracts/heritage_assets/deploy_config.py
...
def deploy() -> None:
    """Deploy the heritage assets contract."""
    # Import directly from contract.py
    from smart_contracts.heritage_assets.contract import heritage_asset_app
