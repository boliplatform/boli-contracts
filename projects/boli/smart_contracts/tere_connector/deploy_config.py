# ~/Desktop/boli/projects/boli/smart_contracts/tere_connector/deploy_config.py
...
def deploy() -> None:
    """Deploy the TERE Connector contract."""
    # Import directly from contract.py
    from smart_contracts.tere_connector.contract import tere_connector
    ...
    try:
        ...
        logger.info(f"Deployed TERE Connector app with ID: {app_id} and address: {app_addr}")
