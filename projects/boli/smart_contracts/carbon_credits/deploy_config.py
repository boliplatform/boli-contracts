# ~/Desktop/boli/projects/boli/smart_contracts/carbon_credits/deploy_config.py
...
def deploy() -> None:
    """Deploy the carbon credits contract."""
    # Import directly from contract.py
    from smart_contracts.carbon_credits.contract import carbon_credit_app
