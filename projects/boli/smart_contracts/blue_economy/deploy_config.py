...
# ~/Desktop/boli/projects/boli/smart_contracts/compliance/deploy_config.py
...
def deploy() -> None:
    ...
    from smart_contracts.compliance.contract import compliance_app
    ...
    # Deploy the app
    try:
        # For compliance app, we need to pass parameters to the initialization
        initialize_args = {
            "regulator_addr": deployer.address,
            "kyc_provider_addr": deployer.address
        }
        
        result = app_client.create(initialize_args=initialize_args)
