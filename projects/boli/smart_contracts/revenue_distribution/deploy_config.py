# ~/Desktop/boli/projects/boli/smart_contracts/revenue_distribution/deploy_config.py
...
def deploy() -> None:
    """Deploy the Revenue Distribution contract."""
    # Import directly from contract.py
    from smart_contracts.revenue_distribution.contract import revenue_distribution_app
    ...
    try:
        ...
        logger.info(f"Deployed Revenue Distribution app with ID: {app_id} and address: {app_addr}")
