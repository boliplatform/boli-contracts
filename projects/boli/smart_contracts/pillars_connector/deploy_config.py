# ~/Desktop/boli/projects/boli/smart_contracts/pillars_connector/deploy_config.py
...
def deploy() -> None:
    """Deploy the Pillars Storage Connector contract."""
    # Import directly from contract.py
    from smart_contracts.pillars_connector.contract import pillars_connector
    ...
    try:
        ...
        logger.info(f"Deployed Pillars Connector app with ID: {app_id} and address: {app_addr}")
