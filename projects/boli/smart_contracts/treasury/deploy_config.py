# ~/Desktop/boli/projects/boli/smart_contracts/treasury/deploy_config.py
...
def deploy() -> None:
    """Deploy the Treasury Management contract."""
    # Import directly from contract.py
    from smart_contracts.treasury.contract import treasury_app
    ...
    try:
        ...
        logger.info(f"Deployed Treasury app with ID: {app_id} and address: {app_addr}")
